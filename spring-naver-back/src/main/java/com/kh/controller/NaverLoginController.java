...
public class NaverLoginController {
	 ...
	 * */
	//appication.properties naver.client-id = 8E6uOChBgfAwM0ZHby_j
	@Value("${naver.client-id}")
	private String clientId; // clientId = 8E6uOChBgfAwM0ZHby_j
	
	//appication.properties naver.client-secret=G8zbc8uPy6
	@Value("${naver.client-secret}")
	private String clientSecret; // clientSecret = G8zbc8uPy6
