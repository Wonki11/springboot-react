...
const Header = () => {
    ...
    //localStrorage : 고객 컴퓨터 웹사이트에 데이터를 영구적으로 저장
    ...
    */
    return(
        ...
        <nav>
            ...
            {/*
            java dto.NaverUser 에 저장된 변수명 중 이름을 가져오고 싶다면 name
            왜나하면 NaverUser에 private String name; 적어놨기 때문
            loginMember ? (<span>환영합니다.{loginMember.}님</span>) : ()
            */}
